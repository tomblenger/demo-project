...
const InvoicePrint = forwardRef<HTMLDivElement, IPropType>(({ orderData }, ref) => {
    ...
    <div ref={ref}>
      ...
      <div className="flex items-center justify-center flex-wrap px-8 mb-6 bg-white border-b border-slate-200 py-6 text-center">
        <div className="relative">
          <h3 className="font-normal mb-0">GadgetHub</h3>
          <p className="mb-0 text-tiny">Karachi, Pakistan</p>
        </div>
      </div>
      {/* top bar end */}
